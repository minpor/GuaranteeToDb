...
@XmlType(name = "zfcs_attachmentType", namespace = "http://zakupki.gov.ru/oos/types/1", propOrder = {
    "publishedContentId",
    "fileName",
    "fileSize",
    "docDescription",
...
@XmlSeeAlso({
    ru.minpor.jaxb.ZfcsRegulationRulesType.Documents.Document.class,
    ru.minpor.jaxb.ZfcsRegulationRulesInvalidType.Documents.Document.class
})
