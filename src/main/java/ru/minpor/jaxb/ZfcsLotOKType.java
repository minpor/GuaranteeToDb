...
@XmlType(name = "zfcs_lotOKType", namespace = "http://zakupki.gov.ru/oos/types/1", propOrder = {
    "lotNumber",
    "lotObjectInfo",
    "maxPrice",
    "priceFormula",
...
@XmlSeeAlso({
    ru.minpor.jaxb.ZfcsNotificationOKType.Lots.Lot.class,
    ru.minpor.jaxb.ZfcsNotificationOKDType.Lots.Lot.class,
    ru.minpor.jaxb.ZfcsNotificationOKOUType.Lots.Lot.class,
    ru.minpor.jaxb.ZfcsNotificationLotChangeType.Lot.class
})
