package ru.minpor.guarantee.test.config;
...
@ComponentScan("ru.minpor.guarantee")
public class TestDataBaseConfig {

    private static final String PROPERTY_NAME_DATABASE_DRIVER = "org.postgresql.Driver";
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:postgresql://192.168.100.7:5432/minpor";
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "ru.minpor.guarantee.entity";
    private static final String PROPERTY_NAME_HIBERNATE_HBM2DDL_AUTO = "create-update";
